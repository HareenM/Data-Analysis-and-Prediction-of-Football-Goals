...
H_Shot=np.histogram2d(shots_model['X'], shots_model['Y'],bins=100,range=[[0, 100],[0, 100]])
goals_only=shots_model[shots_model['Goal']==1]
H_Goal=np.histogram2d(goals_only['X'], goals_only['Y'],bins=100,range=[[0, 100],[0, 100]])
...
plt.show()
fig.savefig('e)Output/1-NumberOfShots.png', dpi=None, bbox_inches="tight")   
...
plt.gca().set_aspect('equal', adjustable='box')
plt.show()
fig.savefig('e)Output/2-NumberOfGoals.png', dpi=None, bbox_inches="tight")   


#Plot the probability of scoring from different points
#Goals/Shots=Frequency of Scoring
(fig,ax) = FCPython.createGoalMouth()
...
plt.gca().set_aspect('equal', adjustable='box')
plt.show()
fig.savefig('e)Output/3-ProbabilityOfScoring.png', dpi=None, bbox_inches="tight")   