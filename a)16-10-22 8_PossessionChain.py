...
def add_possession_chain_sb(figure, chain, team_name: str, opacity: int = 1.0):
    ...
    try:
        for idx, row in chain.iterrows():
            ...
            y = round(((80 - event_loc[1]) * (100 / 80)) / 100, 3)
...
relevand_possessions = match_events[(match_events['type_id'] == 10)]['possession'].unique()  # all uniques possessions with shot
...
ground.save('a)Output/8-possessions.html')